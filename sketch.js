...
function setup() {
	...
	// ativação do engine
	Engine.run(engine);
	pacoteSprite.x = helicopteroSprite.position.x
	pacoteSprite.y = helicopteroSprite.position.y
}
...
function keyPressed(){
 ...
 if(keyCode===RIGHT_ARROW){
	helicopteroSprite.x = helicopteroSprite.x+25
  Matter.Body.translate(pacoteBody,{x:+25,y:0})
}
...
//faça o pacote acompanhar o movimento do helicóptero usando Body.translate
